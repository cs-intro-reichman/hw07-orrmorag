...
public class Sierpinski {
	...
	public static void sierpinski (int n) {
        // Canvas setup (optional but usually helpful)
        StdDraw.clear();
        StdDraw.setScale(0.0, 1.0);
        // Big equilateral triangle coordinates
        double x1 = 0.0, y1 = 0.0;   // left
        double x2 = 1.0, y2 = 0.0;   // right
        double x3 = 0.5, y3 = Math.sqrt(3) / 2.0; // top (height of equilateral triangle)
	...
	private static void sierpinski(int n,
        ...
        sierpinski(n - 1, x1,  x12, x31, y1,  y12, y31); // left
        sierpinski(n - 1, x12, x2,  x23, y12, y2,  y23); // right
